...
The following is a set of guidelines for contributing to Kotlin-Workshop and its packages on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
Before creating bug reports, please check [this list](#before-submitting-a-bug-report) as you might find out that you don't need to create one. When you are creating a bug report, please [include as many details as possible](#how-do-i-submit-a-good-bug-report). Fill out [the required template](https://github.com/Rishit-dagli/Kotlin-Workshop/blob/master/ISSUE_TEMPLATE/bug_report.md), the information it asks for helps us resolve issues faster.
...
All participants of Kotlin-Workshop are expected to abide by our Code of Conduct, both online and during in-person events that are hosted and/or associated with Kotlin-Workshop.
The Pledge
